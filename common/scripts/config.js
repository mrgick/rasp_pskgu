...
const info_panels = {
    ...
    <h2>Мобильная версия расписания</h2>
    <p>
    ...
    <h2>Списочный вид расписания</h2>
    <p>
    ...
    <ul>
        <li>В панели со списком недель или календарём добавлены текущий день (при нажатии 
        ...
        время до следующего начала/конца пары.</li>
        <li>Фильтр календаря "события" удалён</li>
        <li>При нажатии на событие в расписании откроется его панель редактирования</li>
        <li>Добавлена иконка, описание, авторство и ключевые слова сайта расписания</li>
    </ul>
    <h2>Исправления ошибок</h2>
    <ul>
        <li>Исправлены ошибка, приводившая к "смещению" дат в календаре при сравнении расписаний</li>
        <li>Теперь календарь вновь можно проматывать вверх</li>
        <li>Теперь при переходе к одному и тому же дню/неделе несколько раз 
        (с помощью списка недель или календаря) подсвечивание будет работать</li>
    </ul>
    `
}
                        ...
                        'subgroup': ['Подгруппа', {
                            ...
                            'room': ['Место проведения', {
                                      ...
                                      '!result|i4'       :['!result', [/ПОКБ\d?/i                         , // debug
                                                                       ...
                                                                       /Сим.центр1/                       ,
                                                                       /ПОИБ./                            ,
                                                                       /ПОИКБ ул. Майора Доставалова, 14/ ,
                                                                       /ГБУЗПО "Псковская городская клиническая больница"/,
                                                                       /Псковский клинический перинатальный центр/,
                                                                       /Детская областная клиническая больница, Коммунальная ул., 35/,
