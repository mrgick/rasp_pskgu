...
function load_invitation_preset () {
    ...
    document.getElementById('invitation_preserve_container').children[1].value = invitation_preset
}

function save_new_invitation (block) {
    block.classList.add('hidden')
    invitation_preset = document.getElementById('invitation_preserve_container').children[1].value
...
function invitation_changed () {
    document.getElementById('invitation_preserve_container').children[4].classList.remove('hidden')
    document.getElementById('invitation_preserve_container').children[4].classList.remove('hidden')
}
