const info_panels = {
    ...
    <img src='images/events.PNG' alt='Здесь должно было быть изображение'>
    ...
    <img src='images/event_editor.PNG' alt='Здесь должно было быть изображение'>
    ...
    <img src='images/invitation_editor.PNG' alt='Здесь должно было быть изображение'>
    ...
    <h2>Изменения</h2>
    <ul>
        <li>на главной странице сайта, а также снизу страниц с расписанием, появились новые ссылки 
        с новым оформлением</li>
        <li>теперь сайт запоминает что было открыто последним на странице с расписанием - 
        календарь или список недель, убирая необходимость переключения с календаря на список 
        при входе на сайт, если Вам больше нравился список</li>
        <li>при создании события в пункте с указанием времени (пары) автоматически выбирается 
        текущее занятие (например, если Вы создадите событие в 13:00, автоматически будет выбрана 
        3-я пара, поскольку она длится с 12:30 до 14:00)</li>
        <li>если в результатах поиска будет более 50 вариантов, они будут разделены на блоки по 50 штук, 
        распологаемые слева направо, сверху вниз</li>
        <li>на сайте добавлено отслеживание некоторых действий на сайте. Данные неперсонализированные, 
        но отслеживание при желании можно отключить в меню действий справа сверху на главной странице 
        сайта</li>
    </ul>
    `
}
