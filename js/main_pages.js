...
function generate_rasp_page(group)
{
    ...
    <header class="header header--rasp" style="z-index: 3">
                        ...
                        <div class="background_of_setting_menu hidden" id='setting_menu'>
                            <div class="setting_menu">
                                ...
                                <div class="switcher-to_mobile_version" onclick="go_to_mobile_version();">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 0 48 48" width="36px"></svg>
                                </div>
        ...
        <div class="switcher-weekbar" onclick="switch_week_list()">
    ...
    <aside class="event_list hidden" id="EventList">
        <div id='event_bg' onclick='document.getElementById("EventList").classList.add("hidden")'>
        </div>
        <div id='event_panel'>
            <div>
            </div>
