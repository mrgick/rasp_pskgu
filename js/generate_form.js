...
const form_content = {
    ...
    'a2': {
        'title': 'Столкнулись ли Вы с одной или несколькими из нижеперечисленных проблем? ' +
                 '(если нет, укажите проблему в пункте "другое")',
        ...
        'answers': {
            ...
            'В результатах поиска есть группы/преподаватели, которых не должно быть'                              : ['Лишние группы/преподаватели', 'a6'],
            'Ошибка дизайна (Неправильное отображение цветов, результаты не влезают в экран и т.п.)'              : ['Ошибка дизайна', 'a6'],
            'другое (введите сюда)': ['__other_option__', 'a6']
        },
        'condition': 'true',
        'next': 'a6',
        'prev': '',
    ...
    'a3': {
        ...
        'answers': {
            ...
            'Группы/преподавателя нет в списке (укажите имя/группу в следующем пункте)'              : ['Группы/преподавателя нет в списке', 'a7'],
            ...
            'другое (введите сюда)': ['__other_option__', 'a7']
        },
        'condition': 'true',
        'next': 'a7',
        'prev': '',
    ...
    'a4': {
        ...
        'answers': {
            ...
            'другое (введите сюда)': ['__other_option__', 'a8']
        },
        'condition': 'true',
        'next': 'a8',
        'prev': '',
...
function open_thanks_window () {
    ...
    <p>Спасибо за сообщение о проблеме. Постараемся решить её в ближайшее время.</p>
    `
