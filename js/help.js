const info_panels = {
    ...
    <li><a onclick='info_link("user_events")'>руководство "Использование событий"</a></li>
    <h2>Сравнение расписания (НОВОЕ)</h2>
    <p>
    ...
    <h6 style='text-align: center'>
        <img style='width: auto' src='images/rasp_page-comparing.PNG' alt='Здесь должно было быть изображение'>
    </h6>
    <p>
