const info_panels = {
    ...
    <h2>Новые функции календаря</h2>
    <p>
        В новой версии календарь был доработан и приобрёл новые функции: <span style='font-weight: bold'>подписи месяцев</span>, 
        <span style='font-weight: bold'>новые фильтры</span>и <span style='font-weight: bold'>дополнительные условия фильтрации</span>, т.е.:
        <ul>
            <li>теперь справа от календаря будут указываться просмтариваемые месяцы</li>
            <li>помимо загруженности и начала первой пары Вы сможете просмотреть <span style='font-style: italic'>время последней пары</span> и 
            <span style='font-style: italic'>разнообразие мест проведения</span> (например, что в 
            определённый день у Вас будут занятия в 2-х разных корпусах)</li>
            <li>при выборе фильтра, под ним с помощью знаков плюс "+" Вы сможете добавить дополнительные условия поиска. Например, чтобы фильтры подсвечивали 
            только загруженность по онлайн занятиям, или показывалось начало первых пар по русскому языку для 1-ой полугруппы и т.п.</li>
        </ul>
    ...
    <ul>
        <li>Исправлена ошибка, при которой сохранение и очистка фильтров расписания могли не работать в браузерах Opera.</li>
        <li>исправлена ошибка, по которой использование "пользовательской" цветовой темы сайта приводило к некорректному сохранению некоторых фильтров расписания.</li>
    </ul>
    `
}
